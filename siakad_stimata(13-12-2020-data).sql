...
-- Dumping data for table siakad_stimata.master_biaya: ~48 rows (approximately)
...
-- Dumping data for table siakad_stimata.master_dosen: ~62 rows (approximately)
DELETE FROM `master_dosen`;
/*!40000 ALTER TABLE `master_dosen` DISABLE KEYS */;
INSERT INTO `master_dosen` (`nip`, `nidn`, `nama`, `alamat_asal`, `alamat_domisili`, `no_telp`, `email`, `tempat_lahir`, `tgl_lahir`, `keahlian`, `home_base`, `jafa_id`, `jabatan_id`, `status_dosen_id`) VALUES
...
-- Dumping data for table siakad_stimata.master_jabatan_dosen: ~13 rows (approximately)
DELETE FROM `master_jabatan_dosen`;
/*!40000 ALTER TABLE `master_jabatan_dosen` DISABLE KEYS */;
INSERT INTO `master_jabatan_dosen` (`jabatan_id`, `nama`) VALUES
	(1, 'Ketua'),
	(2, 'Waka STMIK'),
	(3, 'BAJAMU'),
...
/*!40000 ALTER TABLE `master_jabatan_dosen` ENABLE KEYS */;
